...
bool Render::DrawTexture2(SDL_Texture* texture, int x, int y, SDL_RendererFlip flip, const SDL_Rect* section, float speed, double angle, int pivotX, int pivotY) const
{
	bool ret = true;
	uint scale = app->win->GetScale();
...
bool Render::DrawText(const char* text, int posx, int posy, int w, int h, int coloreo)
{
